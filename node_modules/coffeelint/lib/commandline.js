...
(function() {
  var CoffeeScript, ErrorReport, coffeelint, config, configfinder, data, deprecatedReporter, errorReport, findCoffeeScripts, fs, getFallbackConfig, glob, lintFiles, lintSource, loadRules, optimist, options, path, paths, read, reportAndExit, resolve, scripts, stdin, thisdir;
