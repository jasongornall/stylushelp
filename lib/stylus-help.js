...
(function() {
  ...
  processData = function(command, args) {
    var addError, alphabetizeCheck, arr, attributeSet, attribute_info, breathing_room, buf, config, count, data, file, file_name, files, filesTotal, indent, infractions, join, line, line_num, line_number, obj, postJsonChecks, preJsonChecks, pre_spaces, processed, read_files, reg, rules, sizeOf, tag, tagFound, tag_found_test, total_return, val, validate, validateInfranction, z_index, _i, _j, _k, _l, _len, _len1, _len2, _len3;
    ...
    switch (command) {
      ...
      case 'checkAlphabetized':
        ...
        for (file_name in data) {
          ...
          for (tag in file) {
            ...
            validateInfranction = (function(_this) {
      ...
      case 'convertStyleToJson':
        ...
        join = function(data_1, data_2) {
          var arg1, arg2, arr_1, arr_2, str, _i, _j, _len, _len1;
          arr_1 = data_1.split(',');
          arr_2 = data_2.split(',');
          str = [];
          for (_i = 0, _len = arr_1.length; _i < _len; _i++) {
            arg1 = arr_1[_i];
            for (_j = 0, _len1 = arr_2.length; _j < _len1; _j++) {
              arg2 = arr_2[_j];
